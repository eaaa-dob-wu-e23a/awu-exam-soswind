          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="aappearance-none rounded-lg relative block w-full px-3 py-2 border border-black-300 placeholder-black-500 text-black rounded-t-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 focus:z-10 text-lg"
